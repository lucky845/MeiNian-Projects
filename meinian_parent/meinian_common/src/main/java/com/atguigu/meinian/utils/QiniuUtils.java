...
public class QiniuUtils {
    ...
    public static String accessKey = "18WlNj3Lpm7mJ9H1xTuYj0WcUlRoLpOgBktiZmKc";
    public static String secretKey = "9FYwPkid-cI1XQNKnG82g3HT1aro-sW96PgJU-KS";
    public static String bucket = "lucky845"; //空间名称
