...
public class MessageConstant {
    ...
    public static final String QUERY_TRAVELITEM_ERROR = "没有查到该项数据";
    public static final String DELETE_SETMEAL_SUCCESS = "删除套餐游成功";
    public static final String DELETE_SETMEAL_FAIL = "删除套餐游失败";
    public static final String EDIT_SETMEAL_SUCCESS = "修改套餐游成功";
    public static final String EDIT_SETMEAL_FAIL = "修改套餐游失败";
}